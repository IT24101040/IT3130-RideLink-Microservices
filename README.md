...
| # | Microservice | Primary Owner | Student ID | Directory |
|---|---|---|---|---|
| 1 | Ride Management Service | Bandara A.R.I.T.A. | IT24100976 | `ride-management-service/` |
| 2 | Driver & Vehicle Service | Wewage H.M.C.D. | IT24101040 | `driver-vehicle-service/` |
| 3 | Fare & Payment Service | Dharmasiri W.K.Y.D. | IT24101183 | `fare-payment-service/` |
